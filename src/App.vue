<template>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark border-bottom border-body">
    <div class="container-fluid">
      <router-link class="navbar-brand" to="/"><h1 class="logo" style="width: 44rem;">VIMA<span>STORE</span></h1></router-link>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <ul class="navbar-nav ms-auto">
          <form class="d-flex" role="search" style="height: 2rem; margin-top: 3.5px; ">
            <button class="btn btn-light" type="submit" style="background-color: #212529; border-color: #212529;"><span class="material-symbols-outlined" style="color: #C7C8C9;">search</span></button>
